...
// Spanish for the recurring combo result phrases from data/combos.json
// (Commander Spellbook source text). Unknown phrases fall back to the English
// source string unchanged.
const COMBO_FEATURE_ES = {
'Infinite creature ETB':'Entradas al campo (ETB) infinitas',
'Infinite creature LTB':'Salidas del campo (LTB) infinitas',
'Infinite card draw':'Robo infinito',
'Infinite colored mana':'Maná de color infinito',
'Infinite colorless mana':'Maná incoloro infinito',
'Infinite white mana':'Maná blanco infinito',
'Infinite blue mana':'Maná azul infinito',
'Infinite black mana':'Maná negro infinito',
'Infinite red mana':'Maná rojo infinito',
'Infinite green mana':'Maná verde infinito',
'Infinite turns':'Turnos infinitos',
'Near-infinite turns':'Turnos casi infinitos',
'Infinite damage':'Daño infinito',
'Near-infinite damage':'Daño casi infinito',
'Infinite damage to one opponent':'Daño infinito a un rival',
'Near-infinite damage to one opponent':'Daño casi infinito a un rival',
'Infinite combat damage':'Daño de combate infinito',
'Infinite combat damage to one opponent':'Daño de combate infinito a un rival',
'Infinite combat phases':'Fases de combate infinitas',
'Infinite death triggers':'Disparos de muerte infinitos',
'Infinite sacrifice triggers':'Disparos de sacrificio infinitos',
'Infinite draw triggers':'Disparos de robo infinitos',
'Infinite landfall triggers':'Disparos de landfall infinitos',
'Near-infinite landfall triggers':'Disparos de landfall casi infinitos',
'Infinite magecraft triggers':'Disparos de magecraft infinitos',
'Infinite lifegain triggers':'Disparos de ganar vida infinitos',
'Infinite self-discard triggers':'Disparos de descarte propio infinitos',
'Infinite lifegain':'Vida infinita',
'Near-infinite lifegain':'Vida casi infinita',
'Infinite lifeloss':'Pérdida de vida infinita',
'Near-infinite lifeloss':'Pérdida de vida casi infinita',
'Infinite lifeloss for target opponent':'Pérdida de vida infinita para un rival',
'Infinite creature tokens':'Tokens de criatura infinitos',
'Near-infinite creature tokens':'Tokens de criatura casi infinitos',
'Infinite creature tokens with haste':'Tokens de criatura con prisa infinitos',
'Infinite Treasure tokens':'Tokens de Tesoro infinitos',
'Infinite tapped Treasure tokens':'Tokens de Tesoro girados infinitos',
'Infinite Blood tokens':'Tokens de Sangre infinitos',
'Infinite Clue tokens':'Tokens de Pista infinitos',
'Infinite blinking':'Parpadeo (blink) infinito',
'Infinite self-mill':'Molino propio infinito',
'Infinite mill':'Molino infinito',
'Infinite proliferate':'Proliferar infinito',
'Infinite scry 1':'Adivinar 1 infinito',
'Infinite storm count':'Cuenta de tormenta infinita',
'Near-infinite storm count':'Cuenta de tormenta casi infinita',
'Infinite commander casts':'Lanzamientos infinitos del comandante',
'Infinite +1/+1 counters on a creature':'Contadores +1/+1 infinitos en una criatura',
'Near-infinite +1/+1 counters on a creature':'Contadores +1/+1 casi infinitos en una criatura',
'Infinite +1/+1 counters on creatures you control':'Contadores +1/+1 infinitos en tus criaturas',
'Infinite +1/+1 counters on most creatures you control':'Contadores +1/+1 infinitos en casi todas tus criaturas',
'Infinite +1/+1 counters on certain creatures':'Contadores +1/+1 infinitos en ciertas criaturas',
'Infinite -1/-1 counters':'Contadores -1/-1 infinitos',
'Infinite charge counters on a permanent':'Contadores de carga infinitos en un permanente',
'Infinite mana lands you control can produce':'Maná infinito del que producen tus tierras',
'Infinite mana creatures you control can produce':'Maná infinito del que producen tus criaturas',
'Infinite mana permanents you control can produce':'Maná infinito del que producen tus permanentes',
'Infinite untap of creatures you control':'Enderezar tus criaturas infinitas veces',
'Infinite card draw for all players':'Robo infinito para todos los jugadores',
'Near-infinite creature ETB':'Entradas al campo (ETB) casi infinitas',
'Infinitely large creature until end of turn':'Criatura infinitamente grande hasta el final del turno',
'Infinitely powerful creature until end of turn':'Criatura infinitamente poderosa hasta el final del turno',
};
export const comboFeatureText = (f, lang) =>
  (lang === 'es' && COMBO_FEATURE_ES[f]) ? COMBO_FEATURE_ES[f] : f;
