...
export function renderPower() {
  ...
  let html = '<div class="power-head">' +
    '<h2 class="secT">' + t.power + '</h2><span class="mono power-pts">' + ev.points + ' ' + t.ptsOf + ' ' + budgetN + '</span></div>';
...
function adviceSections() {
  ...
  if (ev.tier !== 'tier1') {
    ...
    html += '<div class="advice-box adv-down">' +
      '<div class="adv-head"><span class="adv-arrow">▼</span><h3 class="secT">' +
      (ev.tier === 'above' ? t.advDownPod : t.advDownT1) + '</h3>' +
  ...
  if (ev.tier !== 'above') {
    ...
    html += '<div class="advice-box adv-up">' +
      '<div class="adv-head"><span class="adv-arrow">▲</span><h3 class="secT">' + t.advUp + '</h3>' +
